...
?>
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Categories<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        <li><a class="active" href="<?= \yii\helpers\Url::to(['category/create']) ?>">Add Category</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown"><a href="#">Products<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a class="active" href="<?= \yii\helpers\Url::to(['product/index']) ?>">Products List</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
    ...
    yii\bootstrap\Modal::begin([
        ...
        'footer' => '<button type="button" class="btn btn-default" data-dismiss="modal">Continue Shopping</button>
                        <a href="' . \yii\helpers\Url::to(['cart/view']) . '" type="button" class="btn btn-success">Do the Order</a>
                        <button type="button" class="btn btn-danger" onclick="clearCart">Clean the Cart</button>'
    ]);
